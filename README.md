...
- **`tests/RegressionTests.swift`:** Automated test suite running 22 assertions on parser logic, relative date calculation, typo fixes, tricky words, URL extraction, and recurrence rules.
