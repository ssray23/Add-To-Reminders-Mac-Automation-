...
- **Persistent Background Agent:** Runs completely in the background as an `LSUIElement` app. It stays alive after the first launch to ensure subsequent reminders are instantaneous and to seamlessly manage macOS TCC (Permissions) without constant re-prompting.
